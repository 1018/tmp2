...
namespace DockSample
{
    public partial class MainForm : Form
    {
		...
		private DummyDoc CreateNewDocument()
		{
			...
			dummyDoc.Text = text;
            dummyDoc.CloseButtonVisible = false;
            dummyDoc.MaximizeBox = false;
            dummyDoc.Size = new Size(800, 800);
            dummyDoc.AutoSize = false;
            dummyDoc.MinimumSize = dummyDoc.Size;
            dummyDoc.FormBorderStyle = FormBorderStyle.Fixed3D;
