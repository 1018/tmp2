...
{
    public class TextObject : ShapeObject
    {
        ...
        private Font  drawFont = new Font("ＭＳ Ｐゴシック", 11);

        private int              _BorderWidth = 1;
        private Color            _BorderColor = Color.Black;
        private DashStyle        _BorderStyle = DashStyle.Solid;
        private string           _TextString;
        private Font             _TextFont = new Font("ＭＳ Ｐゴシック", 11);
        ...
        [Visible(true), DisplayName("文字色"), Category("01 表示")]        
        ...
        [Visible(true), DisplayName("文字"), Category("01 表示")]
        ...
        [Visible(true), DisplayName("フォント"), Category("01 表示")]
        ...
        [Visible(true), DisplayName("文字表示位置"), Category("01 表示")]
        ...
        public override void ReMake()
        {
            ...
            drawFont = new Font(this.TextFont.Name, (float)(this.TextFont.Size * ParentForm.Zoom), this.TextFont.Style);
                      

            drawing = new TextDrawing(this.BorderColor, this.drawBorderWidth, this.BorderStyle, this.FillColor,
                                      this.TextColor, this.TextString, this.drawFont, this.TextAlignment, drawPoints);
        ...
        //{
        //    //コントロールコピー
        //    TextObject obj = (TextObject)this.Clone();
